...
class CategoryRightsCopyForm extends AbstractForm  {
	 ...
	 */
	public $activeMenuItem = 'blog.acp.menu.link.blog.category.rights.copy';

	/**
	 * @see	\wcf\page\AbstractPage::$neededPermissions
	 */
	public $neededPermissions = array('admin.blog.canManageCategory');
	...
	public function readParameters() {
		...
		$this->objectTypeID = ACLHandler::getInstance()->getObjectTypeID('com.woltlab.blog.category');
	}
	...
	public function assignVariables() {
		...
		$categoryTree = new blogCategoryNodeTree('com.woltlab.blog.category', 0, true, array());

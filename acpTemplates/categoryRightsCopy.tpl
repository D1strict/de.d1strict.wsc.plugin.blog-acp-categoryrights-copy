{include file='header' pageTitle='blog.acp.blog.category.rights.copy'}
...
<header class="boxHeadline">
	<h1>{lang}blog.acp.blog.category.rights.copy{/lang}</h1>
</header>
...
<form method="post" action="{link application='blog' controller='CategoryRightsCopy'}{/link}">
	<div class="tabMenuContainer" data-active="{$activeTabMenuItem}" data-store="activeTabMenuItem">
		<nav class="tabMenu">
			<ul>
				<li><a href="{@$__wcf->getAnchor('general')}">{lang}blog.acp.blog.category.rights.copy{/lang}</a></li>
			...
			<fieldset>
				{hascontent}
					<dl{if $errorField == 'sourceCategoryID'} class="formError"{/if}>
						<dt><label for="sourceCategoryID">{lang}blog.acp.blog.category.sourceCategoryID{/lang}</label></dt>
						<dd>
							...
							{if $errorField == 'sourceCategoryID'}
								<small class="innerError">
									{lang}blog.acp.blog.category.sourceCategoryID.error.{@$errorType}{/lang}
								</small>
							{/if}
						</dd>
					</dl>
				...
				{hascontent}
					<dl {if $errorField == 'targetCategoryIDs'} class="formError"{/if}>
					    <dt><label for="targetCategoryIDs">{lang}blog.acp.blog.category.targetCategoryIDs{/lang}</label></dt>
					    <dd>
							...
							{if $errorField == 'targetGroupIDs'}
								<small class="innerError">
									{lang}blog.acp.blog.category.targetCategoryID.error.{@$errorType}{/lang}
								</small>
							{/if}
					    </dd>
					</dl>
	...
	<div class="formSubmit">
		<input type="submit" value="{lang}blog.acp.blog.category.copy{/lang}" accesskey="s" />
